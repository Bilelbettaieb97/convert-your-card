...
import { PublicLinkBar, QrCard, ShareGrid } from "@/components/dashboard/ShareGrid";
        ...
        <Tabs defaultValue="content" className="w-full">
          ...
          <TabsContent value="style" className="mt-0 space-y-4">
            <SectionHeader
              ...
              subtitle="Chaque brique propose plusieurs variantes visuelles."
            />
