...
export const Route = createFileRoute("/templates")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://cartevisitedigitale.fr/templates" },
      ...
      { name: "twitter:title", content: "Modèles de cartes de visite digitales par secteur — CVD" },
      { name: "twitter:description", content: "Plus de 40 modèles classés par métier. Personnalisez le vôtre en 3 minutes." },
    ],
    links: [{ rel: "canonical", href: "https://cartevisitedigitale.fr/templates" }],
  }),
