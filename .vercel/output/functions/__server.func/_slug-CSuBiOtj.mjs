...
import { R as Route$r, e as THEMES_BY_ID, C as CARD_THEMES } from "./_ssr/router-C6JWeKL5.mjs";
import { B as BusinessCard } from "./_ssr/BusinessCard-EckYp6vc.mjs";
import "./_libs/sonner.mjs";
import "./_libs/seroval.mjs";
import { E as ExternalLink, D as Download, aa as Calendar, ay as Phone, o as MapPin, G as Globe, r as Mail } from "./_libs/lucide-react.mjs";
...
import "./_ssr/server-B5jiB6Ew.mjs";
...
function ProfilePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex flex-col items-center py-8 px-4", style: {
    ...
    reseaux.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl p-4 mb-4", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: reseaux.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: r.url, target: "_blank", rel: "noopener noreferrer", onClick: () => logEvent(profile.id, "click_social", {
        type: r.type
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-xs mt-6", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "font-semibold hover:underline", style: {
        color: theme.accent
      }, children: "Carte Visite Digitale" })
    ] })
  ] }) });
}
function ActionButton({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: hrefs[btn.type] ?? "#", target: openInNew ? "_blank" : void 0, rel: "noopener noreferrer", onClick: () => logEvent(profileId, "click_button", {
    type: btn.type
