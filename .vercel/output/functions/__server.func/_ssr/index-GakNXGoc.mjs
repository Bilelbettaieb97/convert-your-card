...
import { T as Toaster } from "./router-DIf0f6dh.mjs";
import "../_libs/seroval.mjs";
import { U as Users, aL as Plus, aM as ToggleRight, aN as ToggleLeft, a4 as ExternalLink } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "border-b border-border bg-card px-6 py-4 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-bold text-foreground", children: "Admin OneTap" }),
