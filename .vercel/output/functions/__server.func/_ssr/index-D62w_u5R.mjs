...
import { i as Countdown } from "./router-BdhCrU0p.mjs";
import "../_libs/sonner.mjs";
import "../_libs/seroval.mjs";
import { Z as Zap, L as LayoutDashboard, z as LogOut, c as CreditCard, S as Shield, n as Truck, y as Sparkles, a6 as Check, a2 as X, A as ArrowRight, au as ChevronDown, a9 as Star, e as Clock, h as Building2, ay as House, H as UtensilsCrossed, a0 as GraduationCap, N as Scissors, J as HardHat, az as Smartphone, aA as BadgeCheck, U as Users, j as ChartColumn, aB as Award, aC as ThumbsUp, P as Play, aD as ChevronLeft, d as ChevronRight, R as RefreshCw, ad as Lock, aE as Headphones, aF as Leaf, w as TrendingUp, aG as Quote, M as MessageCircle, aH as ShoppingBag, o as MapPin, a5 as Gift, aI as LoaderCircle, ar as Wifi, ax as Phone, r as Mail, G as Globe, aJ as Linkedin, aK as Instagram } from "../_libs/lucide-react.mjs";
...
function DigitalCardVisual() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-md mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-brand rounded-2xl p-5 text-primary-foreground shadow-card relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs opacity-90", children: "CEO · CVD Studio" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mt-4 flex items-center gap-2 text-xs", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "cartevisitedigitale.fr/julien" })
          ] })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:block absolute -bottom-6 -right-8 w-56 h-32 rounded-2xl bg-gradient-brand shadow-glow animate-float p-4 text-primary-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-widest opacity-80", children: "CVD" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-16 sm:py-20 bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10 sm:mb-14", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight", children: "Ils racontent leur CVD en 30 secondes" }),
...
function HeroCTA() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center flex-1 rounded-xl border border-border bg-card focus-within:ring-2 focus-within:ring-magenta/30 focus-within:border-magenta transition overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pl-4 pr-1 text-xs text-muted-foreground whitespace-nowrap shrink-0 select-none", children: "cartevisitedigitale.fr/" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: slug, onChange: (e) => setSlug(e.target.value), onKeyDown: (e) => e.key === "Enter" && handleStart(), placeholder: "votrenom", className: "flex-1 py-4 pr-4 bg-transparent text-foreground placeholder:text-muted-foreground/60 focus:outline-none font-medium min-w-0" })
    ] }),
...
function Logos() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-y border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-6 flex flex-wrap items-center justify-center gap-x-10 gap-y-4 text-muted-foreground/70 text-sm font-display font-semibold tracking-wider", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase", children: "Ils utilisent CVD :" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-14 relative grid md:grid-cols-2 gap-8 lg:gap-6 items-stretch", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl border-2 border-magenta/30 bg-gradient-to-br from-magenta/[0.04] to-transparent p-6 sm:p-8 flex flex-col shadow-2xl shadow-magenta/10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-magenta font-semibold", children: "CVD Digital" })
          ] }),
...
function HowItWorks() {
  const templates = [{
    ...
    location: "Paris",
    website: "cartevisitedigitale.fr/sm",
    phone: "+33 6 10 20 30 40",
    email: "sm@lumiere.fr",
    ...
    location: "Lyon",
    website: "cartevisitedigitale.fr/ar",
    ...
    location: "Bordeaux",
    website: "cartevisitedigitale.fr/lm",
    phone: "+33 6 12 22 32 42",
    ...
    location: "Toulouse",
    website: "cartevisitedigitale.fr/ml",
...
function Pricing() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "offres", className: "py-20 lg:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-14 grid lg:grid-cols-3 gap-6 lg:gap-5 items-stretch max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "order-2 lg:order-1 flex max-w-md mx-auto w-full lg:max-w-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(OfferCard, { name: "CVD Essentielle", tagline: "La carte digitale qui convertit", oldPrice: "33€", price: "19,80€", badge: "Digital only", features: [{
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "order-1 lg:order-2 flex max-w-md mx-auto w-full lg:max-w-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(OfferCard, { name: "CVD Physique", tagline: "Carte NFC + page digitale", oldPrice: "48€", price: "28,80€", badge: "⭐ Le plus populaire", highlight: true, stockLeft: 32, stockTotal: 100, valueStack: [{
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "order-3 lg:order-3 flex max-w-md mx-auto w-full lg:max-w-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(OfferCard, { name: "CVD Premium", tagline: "Analytics & multi-cartes", oldPrice: "79€", price: "48€", badge: "Pour les équipes", features: [{
...
function ComparisonTable() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 max-w-6xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block rounded-2xl border border-border bg-card shadow-sm overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("caption", { className: "sr-only", children: "Comparatif des formules CVD" }),
...
function Comparison() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 lg:py-28 bg-gradient-soft", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center max-w-2xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl sm:text-4xl", children: [
      "Papier vs. ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Carte Visite Digitale" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 bg-card border border-border rounded-3xl overflow-hidden shadow-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 bg-secondary text-sm font-semibold", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-center bg-gradient-brand text-primary-foreground", children: "CVD" })
      ] }),
...
function StickyMobileCTA() {
  ...
  }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-3 mb-2 bg-card/95 backdrop-blur-lg border border-border rounded-2xl shadow-2xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/inscription", className: "flex items-center justify-center p-3 active:scale-[0.98] transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-gradient-cta text-primary-foreground rounded-xl py-3.5 px-3 text-center shadow-glow", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-bold text-[16px] leading-tight flex items-center justify-center gap-1.5", children: [
      "Créer ma carte",
      /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4" })
    ] }),
