...
import { g as getProfileMeta } from "./router-BdhCrU0p.mjs";
import "../_libs/sonner.mjs";
import "../_libs/seroval.mjs";
import { R as RefreshCw, ad as Lock, a1 as Eye, aO as MousePointerClick, aW as UserPlus, w as TrendingUp, j as ChartColumn, M as MessageCircle, a6 as Check, ap as Copy, Q as QrCode, Z as Zap, aX as ArrowUpRight, q as Bell, aY as Target, ac as Share2, D as Download, aa as Calendar, G as Globe, r as Mail, ax as Phone } from "../_libs/lucide-react.mjs";
...
function eventToNotif(row) {
  ...
  const MAP = {
    ...
    click_button: {
      ...
      title: clickLabel ? `Clic « ${clickLabel} »` : "Clic bouton d'action"
    },
    click_social: {
      icon: MousePointerClick,
      color: "text-sky-400 bg-sky-500/10",
      title: clickLabel ? `Réseau — ${clickLabel}` : "Clic réseau social"
    },
    vcard_download: {
      icon: UserPlus,
...
function StatistiquesPage() {
  ...
  const refresh = reactExports.useCallback(() => {
    if (!profileId) return;
    setRefreshing(true);
    Promise.all([supabase.from("nfc_analytics").select("event_type, created_at, event_data").eq("profile_id", profileId).order("created_at", {
      ascending: true
    }).then(({
      data
    }) => {
      if (data) setAnalytics(data);
    }), supabase.from("nfc_analytics").select("id, event_type, created_at, event_data").eq("profile_id", profileId).order("created_at", {
      ascending: false
    }).limit(30).then(({
      data
    }) => {
  ...
  reactExports.useEffect(() => {
    ...
    supabase.from("nfc_analytics").select("id, event_type, created_at, event_data").eq("profile_id", profile.id).order("created_at", {
      ascending: false
    }).limit(30).then(({
      data
    }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5 lg:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-[1fr_300px] gap-6 max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 min-w-0", children: [
      ...
      !hasData ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { totalScans, cardUrl, copied, onCopy: copyLink }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      LOCKED_PERIODS.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl p-5 relative overflow-hidden", style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard/account", className: "inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-xs font-bold text-white transition hover:opacity-90", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border bg-card/40 overflow-hidden sticky top-24", children: feed.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-10 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "h-8 w-8 mx-auto opacity-20 mb-3" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground leading-relaxed", children: [
          "Aucune activité.",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opacity-70", children: "Les scans et interactions apparaîtront ici." })
        ] })
      ] }) : feed.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 p-3.5 border-b border-border/50 last:border-b-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-8 w-8 rounded-xl grid place-items-center shrink-0 ${n.color}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(n.icon, { className: "h-3.5 w-3.5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-medium text-foreground leading-snug", children: n.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground mt-0.5", children: n.sub })
        ] })
      ] }, n.id)) })
    ] })
  ] }) });
