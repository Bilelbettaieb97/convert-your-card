...
import { u as useCardStore, h as getProfileMeta, B as Button, a as cn } from "./router-Cfip1LhP.mjs";
...
import { N as Sparkles, A as ArrowRight, x as Eye, y as MousePointerClick, H as Smartphone, Q as QrCode, c as CircleCheck, p as Circle, Z as Zap, C as CreditCard, ae as Palette, ad as Share2, k as TrendingUp, aN as TrendingDown } from "../_libs/lucide-react.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-gradient-to-br from-card to-card/30 p-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(QuickAction, { to: "/dashboard/account", icon: TrendingUp, label: "Passer à Vitrine", hint: "Débloquer tout", highlight: true })
          ] })
        ] }),
