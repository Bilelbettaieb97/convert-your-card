...
import { l as Route } from "./router-DLZPm_g8.mjs";
import "../_libs/sonner.mjs";
import "../_libs/seroval.mjs";
import { a3 as ArrowLeft, Z as Zap, e as Clock, a8 as Star, a5 as Check, S as Shield } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "lg:hidden px-4 py-4 border-b border-border flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold", children: "CVD" })
      ] })
    ] }),
