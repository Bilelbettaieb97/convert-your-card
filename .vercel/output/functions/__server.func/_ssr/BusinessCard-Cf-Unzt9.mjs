...
import { l as THEMES_BY_ID } from "./router-BcV3gn0O.mjs";
...
function GallerySection({ data }) {
  ...
  if (v === "carousel") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex gap-2 overflow-x-auto px-5 pb-2 snap-x snap-mandatory [scrollbar-width:none] [&::-webkit-scrollbar]:hidden", children: gallery.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "snap-start shrink-0 w-[72%] rounded-2xl overflow-hidden bg-card-surface border border-card-border", children: [
