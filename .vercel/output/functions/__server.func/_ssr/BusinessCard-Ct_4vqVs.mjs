...
import { l as THEMES_BY_ID } from "./router-3Cz-jfVx.mjs";
import { d as downloadVCard } from "./vcard-D7QWDY7x.mjs";
import { B as Building2, ab as Share2, aB as BadgeCheck, s as MapPin, af as Image, aK as Linkedin, aL as Instagram, p as MessageCircle, aa as ExternalLink, t as Phone, M as Mail, G as Globe, A as ArrowRight, aT as Languages, a8 as Calendar, az as ChevronRight, H as Sparkles, aI as Quote, aC as Award, D as Download, aU as CirclePlay, r as Star } from "../_libs/lucide-react.mjs";
...
function GallerySection({ data }) {
  ...
  if (v === "carousel") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { children: "Galerie" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex gap-2 overflow-x-auto px-5 pb-2 snap-x snap-mandatory [scrollbar-width:none] [&::-webkit-scrollbar]:hidden", children: data.gallery.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "snap-start shrink-0 w-[72%] rounded-2xl overflow-hidden bg-card-surface border border-card-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[3/4] overflow-hidden bg-card-surface-alt", children: p.img ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.img, alt: p.caption, className: "h-full w-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full w-full grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { className: "h-8 w-8 text-card-muted" }) }) }),
        p.caption && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-card-muted px-3 py-2 truncate", children: p.caption })
      ] }, p.id)) })
    ] });
  }
  if (v === "stacked") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-5 space-y-3", children: [
      ...
      data.gallery.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl overflow-hidden bg-card-surface border border-card-border", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { children: "Galerie" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 grid grid-cols-2 gap-2", children: data.gallery.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl overflow-hidden bg-card-surface border border-card-border", children: [
