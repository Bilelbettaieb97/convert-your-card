...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CyEYVwNX.mjs");
...
const manifest = {
  "0120aeaa0f47d7c1f4e57cd64d068c07586b4cb2e48a69607fe50ccd733d2a79": {
    functionName: "signUpWithAutoConfirm_createServerFn_handler",
    importer: () => import("./signup-DopUmQgj.mjs")
  },
  "2e17a70aeffaf4196790c75ccf3602084408674a8cc1fb8f8e0218e607ad3e55": {
    functionName: "createPortalSession_createServerFn_handler",
    importer: () => import("./billing-portal-CCT8Msmx.mjs")
  },
  "3abe21163060cdaebf0fca822dbccd0e90b15179a021cd21c9f2b19df9296d49": {
    functionName: "getProfile_createServerFn_handler",
    importer: () => import("../_slug-D3Z8bPwt.mjs")
  },
  "42940a7c372e29724e93284d98b4c48664406802d496bfae41a4d75b04cc26f3": {
    functionName: "getStripeCard_createServerFn_handler",
    importer: () => import("./stripe-card-iIZZEAAY.mjs")
  },
  "73033594ac1edfd8b627fe3a9eeccaaab479f666cbb41cc712f872db98fad95d": {
    functionName: "getStripeInvoices_createServerFn_handler",
    importer: () => import("./stripe-invoices-PQxTTwcb.mjs")
  },
  "e73a7067186170481118eecabe235613902296d3774a9001243b8a25d55e3d56": {
    functionName: "createCheckoutSession_createServerFn_handler",
    importer: () => import("./checkout-tDisxuV2.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B-iL4scT.mjs").then((n) => n.r),
    import("./start-DujKfZ5l.mjs"),
