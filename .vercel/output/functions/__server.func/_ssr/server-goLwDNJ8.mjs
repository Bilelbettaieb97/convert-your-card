...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cgm_YF_u.mjs");
...
const manifest = {
  ...
  "d730682d06b2b46d258564a49e121f6f26d3544c98cfe142af932c83bdef04fd": {
    ...
    importer: () => import("./statistiques-DjlzNQT-.mjs")
  },
  "e73a7067186170481118eecabe235613902296d3774a9001243b8a25d55e3d56": {
    ...
    importer: () => import("./checkout-BHHqH7vz.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-5ru0r8H0.mjs").then((n) => n.r),
    import("./start--GgzG6y-.mjs"),
