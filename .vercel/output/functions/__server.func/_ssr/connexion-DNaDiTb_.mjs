...
import { T as Toaster } from "./router-jjFbu4MP.mjs";
import "../_libs/seroval.mjs";
import { Z as Zap, r as Mail, ap as EyeOff, a1 as Eye } from "../_libs/lucide-react.mjs";
...
function ConnexionPage() {
  ...
  const [sendingMagic, setSendingMagic] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-soft flex items-center justify-center px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm", children: [
      ...
      magicSent ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl shadow-card p-7 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground mb-5 break-all", children: email }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setMagicSent(false), className: "text-xs text-muted-foreground hover:text-foreground transition underline underline-offset-2", children: "Retour" })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 my-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "ou avec mot de passe" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: submitting, className: "w-full border border-border text-foreground rounded-full py-2.5 text-sm font-medium hover:bg-muted transition-all disabled:opacity-60", children: submitting ? "Connexion…" : "Se connecter avec mot de passe" })
        ] })
      ] }),
