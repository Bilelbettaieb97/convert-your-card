...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-kTa6ciEM.mjs");
...
const manifest = {
  ...
  "e73a7067186170481118eecabe235613902296d3774a9001243b8a25d55e3d56": {
    ...
    importer: () => import("./checkout-B14nNmAV.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Bmg7SHe7.mjs").then((n) => n.r),
    import("./start-D3RAZ3s4.mjs"),
