...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C40Yr5kE.mjs");
...
const manifest = {
  "3abe21163060cdaebf0fca822dbccd0e90b15179a021cd21c9f2b19df9296d49": {
    ...
    importer: () => import("../_slug-CMY6Vi_5.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C7tNH_1b.mjs").then((n) => n.r),
    import("./start-WbxyCeWM.mjs"),
