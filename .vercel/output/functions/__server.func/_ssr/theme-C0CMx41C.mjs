...
import { B as BusinessCard } from "./BusinessCard-4eOIBhtC.mjs";
import { P as PhoneFrame } from "./PhoneFrame-B9V-8JK3.mjs";
import { u as useCardStore, h as getProfileMeta, C as CARD_THEMES } from "./router-DXAqO7PW.mjs";
import { l as loadMyCard, u as updateCard } from "./card-actions-S_H6Qopc.mjs";
...
function ThemeGroup({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3", children: themes.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeCard, { id: t.id, label: t.label, sector: t.sector, palette: t.palette, active: activeId === t.id, onSelect }, t.id)) })
  ] });
}
function ThemeCard({
  id,
