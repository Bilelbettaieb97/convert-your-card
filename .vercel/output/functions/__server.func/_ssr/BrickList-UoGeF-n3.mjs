...
import { l as DEFAULT_SECTION_ORDER, S as Switch } from "./router-DYFJo9xc.mjs";
import { h as useSensors, i as useSensor, D as DndContext, f as closestCenter, j as KeyboardSensor, P as PointerSensor } from "../_libs/dnd-kit__core.mjs";
...
import { B as BRICK_META, r as renderBrickBody, V as VariantPicker } from "./bricks-DrRSeX81.mjs";
import { ax as GripVertical } from "../_libs/lucide-react.mjs";
function BrickList({ data, update, setData, styleOnly = false }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DndContext, { sensors, collisionDetection: closestCenter, onDragEnd, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SortableContext, { items: sectionOrder, strategy: verticalListSortingStrategy, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { type: "single", collapsible: true, defaultValue: sectionOrder[0], className: "space-y-3", children: sectionOrder.map((id) => {
