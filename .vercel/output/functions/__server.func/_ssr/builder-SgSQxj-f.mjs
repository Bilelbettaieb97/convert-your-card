...
import { u as useCardStore, k as PROFESSIONS, l as THEMES_BY_ID, m as PROFESSION_CATEGORIES, I as Input, C as CARD_THEMES, n as PROFESSIONS_BY_THEME, j as DEFAULT_CARD, S as Switch, b as useAuthStore, B as Button, a as cn } from "./router-Cfip1LhP.mjs";
import { P as PhoneFrame, B as BusinessCard, r as renderBrickBody } from "./bricks-Canljfgp.mjs";
...
function BuilderSections({ step, data, setData, update, plan, setPlan, completedThrough, onGoToStep, onBack, onNext }) {
  ...
  const previewData = isEssentials ? {
    ...data,
    statsEnabled: false,
    videoEnabled: false,
    servicesEnabled: false,
