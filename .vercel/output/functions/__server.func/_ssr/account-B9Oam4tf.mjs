...
import { b as useAuthStore, B as Button } from "./router-B06Pcelu.mjs";
import { C as Card } from "./card-BXLtBCdd.mjs";
import { U as UpsellSection } from "./UpsellSection-DV1Xg28x.mjs";
import { supabase } from "./client-CrY6GqN9.mjs";
import "../_libs/seroval.mjs";
import "../_libs/sonner.mjs";
import { a as Crown, H as Check, M as Mail, W as LogOut } from "../_libs/lucide-react.mjs";
...
function AccountPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-5 py-8 space-y-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: PLANS.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: `p-5 relative ${p.highlight ? "border-primary/60 shadow-[var(--shadow-elegant)]" : ""}`, children: [
        p.highlight && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute -top-2 right-4 inline-flex items-center gap-1 text-[10px] uppercase tracking-wider bg-primary text-primary-foreground px-2 py-0.5 rounded-full", children: [
        ...
        p.current ? /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", disabled: true, className: "w-full", children: "Plan actuel" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/pricing", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "w-full", children: [
          "Passer à ",
          p.label
        ] }) })
      ] }, p.id)) })
