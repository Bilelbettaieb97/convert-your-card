...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C9K52MRG.mjs");
...
const manifest = {
  "0120aeaa0f47d7c1f4e57cd64d068c07586b4cb2e48a69607fe50ccd733d2a79": {
    ...
    importer: () => import("./signup-p76Je-VG.mjs")
  },
  "3abe21163060cdaebf0fca822dbccd0e90b15179a021cd21c9f2b19df9296d49": {
    functionName: "getProfile_createServerFn_handler",
    importer: () => import("../_slug-j1TSnp-c.mjs")
  },
  "d730682d06b2b46d258564a49e121f6f26d3544c98cfe142af932c83bdef04fd": {
    functionName: "fetchProfileAnalytics_createServerFn_handler",
    importer: () => import("./statistiques-COksEp_F.mjs")
  },
  "e73a7067186170481118eecabe235613902296d3774a9001243b8a25d55e3d56": {
    ...
    importer: () => import("./checkout-B7yuiNDw.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-AloPJc8O.mjs").then((n) => n.r),
    import("./start-Dy4Df0Gw.mjs"),
