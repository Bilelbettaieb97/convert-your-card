...
import { i as Countdown } from "./router-ccj0AfJi.mjs";
...
function HeroCTA() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground font-medium text-xs whitespace-nowrap", children: "cartevisitedigitale/" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: slug, onChange: (e) => setSlug(e.target.value), onKeyDown: (e) => e.key === "Enter" && handleStart(), placeholder: "votrenom", className: "w-full pl-[9.5rem] pr-4 py-4 rounded-xl border border-border bg-card text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-magenta/30 focus:border-magenta transition font-medium" })
    ] }),
