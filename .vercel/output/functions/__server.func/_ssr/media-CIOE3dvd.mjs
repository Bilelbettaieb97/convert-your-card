...
import { b as useAuthStore, u as useCardStore, h as getProfileMeta, B as Button } from "./router-N21Us5v3.mjs";
import { l as loadMyCard, u as updateCard } from "./card-actions-jToNoFsQ.mjs";
import { B as BusinessCard } from "./BusinessCard-DYsied1R.mjs";
import { P as PhoneFrame } from "./PhoneFrame-B9V-8JK3.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import "../_libs/seroval.mjs";
import { aW as CircleUserRound, aJ as LoaderCircle, au as Upload, aX as LayoutTemplate, af as Image, u as Check, aq as Copy, T as Trash2, r as Star, aY as CirclePlus, q as Tag } from "../_libs/lucide-react.mjs";
...
function MediaPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1400px] px-5 sm:px-8 py-8 grid grid-cols-1 xl:grid-cols-[1fr_380px] gap-8 items-start", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-8", children: [
      ...
      (hasTestimonials || hasListings) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        hasTestimonials && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: hasListings ? "mb-6" : "", children: [
          ...
          data.testimonials.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard/content", className: "flex items-center gap-2 text-xs text-muted-foreground hover:text-foreground transition py-3 px-4 rounded-xl border border-dashed border-border hover:border-primary/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: "h-4 w-4 shrink-0" }),
        ...
        hasListings && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          data.listings.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard/content", className: "flex items-center gap-2 text-xs text-muted-foreground hover:text-foreground transition py-3 px-4 rounded-xl border border-dashed border-border hover:border-primary/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: "h-4 w-4 shrink-0" }),
