...
import { u as useCardStore, B as Button, c as createSsrRpc } from "./router-DYFJo9xc.mjs";
import { C as Card } from "./card-BWG_qABo.mjs";
import { A as Accordion, a as AccordionItem, b as AccordionTrigger, c as AccordionContent } from "./accordion-DZXlJn4O.mjs";
import { U as UpsellSection } from "./UpsellSection-Be9fQRyL.mjs";
import { l as loadMyCard, c as createCard } from "./card-actions-BvxbWz0n.mjs";
import { c as createServerFn } from "./server-DptaZHos.mjs";
import { supabase } from "./client-CrY6GqN9.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import "../_libs/seroval.mjs";
import { a4 as ArrowLeft, p as ShieldCheck, y as Sparkles, g as Crown, a5 as Gift, a6 as Check, e as Clock, a2 as X, a7 as Rocket, a8 as Coffee, w as TrendingUp, U as Users, a9 as Star, aa as Calendar } from "../_libs/lucide-react.mjs";
...
function PricingPage() {
  ...
  async function handleActivate(planOverride) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen bg-background text-foreground pb-32", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-5xl px-5 pt-8 pb-6 grid grid-cols-1 md:grid-cols-[1fr_1.15fr] gap-5 items-stretch", children: PLANS.map((p) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setSelected(p.id), className: "group relative text-left transition focus:outline-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: `p-6 sm:p-7 h-full transition border-2 ${isSelected ? "border-primary shadow-[var(--shadow-elegant)]" : "border-border hover:border-foreground/20"} ${isHighlight ? "bg-gradient-to-br from-primary/[0.06] to-transparent" : "opacity-95"}`, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "w-full h-11 text-base", variant: isHighlight ? "default" : "outline", size: isHighlight ? "lg" : "default", disabled: creating !== null, onClick: (e) => {
          e.stopPropagation();
          setSelected(p.id);
          handleActivate(p.id);
        }, children: [
          isHighlight && creating !== "vitrine" && /* @__PURE__ */ jsxRuntimeExports.jsx(Rocket, { className: "h-4 w-4 mr-2" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-0 left-0 right-0 z-30 border-t border-border bg-background/95 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-5 py-3 flex items-center justify-between gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "lg", className: "h-12 shadow-[var(--shadow-elegant)] shrink-0", onClick: () => handleActivate(), disabled: creating !== null, children: creating !== null ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: "Activation en cours…" }) : selected === "vitrine" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
