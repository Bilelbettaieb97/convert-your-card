...
import { g as getProfileMeta, c as createSsrRpc } from "./router-5ru0r8H0.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { c as createServerFn } from "./server-goLwDNJ8.mjs";
import { supabase } from "./client-CrY6GqN9.mjs";
import "../_libs/sonner.mjs";
import "../_libs/seroval.mjs";
import { aB as RefreshCw, as as Lock, m as Eye, n as MousePointerClick, r as UserPlus, p as TrendingUp, ai as ChartColumn, k as MessageCircle, l as Check, ak as Copy, Q as QrCode, Z as Zap, aS as ArrowUpRight, aT as Target, a5 as Share2, D as Download, a2 as Calendar, G as Globe, M as Mail, au as Phone } from "../_libs/lucide-react.mjs";
...
const fetchProfileAnalytics = createServerFn({
  method: "POST"
}).validator((input) => input).handler(createSsrRpc("d730682d06b2b46d258564a49e121f6f26d3544c98cfe142af932c83bdef04fd"));
function daysBack(n) {
...
function StatistiquesPage() {
  ...
  const loadData = reactExports.useCallback(async (pid) => {
    const rows = await fetchProfileAnalytics({
      data: {
        profileId: pid
      }
    });
