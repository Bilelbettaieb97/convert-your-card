...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-6uEJw5Q2.mjs");
...
const manifest = {
  ...
  "e73a7067186170481118eecabe235613902296d3774a9001243b8a25d55e3d56": {
    ...
    importer: () => import("./checkout-Bjpy6FDo.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CtHcEMJU.mjs").then((n) => n.v),
    import("./start-Df2E2geo.mjs"),
