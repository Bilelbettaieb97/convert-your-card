...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D-9sv9j0.mjs");
...
const manifest = {
  ...
  "e73a7067186170481118eecabe235613902296d3774a9001243b8a25d55e3d56": {
    ...
    importer: () => import("./checkout-Di29pPiy.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-cnviN2Vz.mjs").then((n) => n.r),
    import("./start-DPDxnisY.mjs"),
