...
import { u as useCardStore, d as PROFESSIONS, e as THEMES_BY_ID, f as PROFESSION_CATEGORIES, I as Input, D as DEFAULT_CARD, C as CARD_THEMES, h as PROFESSIONS_BY_THEME, b as useAuthStore, B as Button, S as Switch, a as cn } from "./router-C6JWeKL5.mjs";
import { B as BusinessCard } from "./BusinessCard-EckYp6vc.mjs";
import { P as PhoneFrame } from "./PhoneFrame-B9V-8JK3.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { D as DndContext, f as closestCenter } from "../_libs/dnd-kit__core.mjs";
...
import { r as renderBrickBody } from "./bricks-Duwd4s4_.mjs";
import "../_libs/seroval.mjs";
import { au as PanelsTopLeft, ag as Palette, b as Search, av as ChevronDown, a6 as Check, aw as SkipForward, y as Sparkles, C as CircleCheck, e as Clock, a9 as Star, U as Users, a7 as Rocket, A as ArrowRight, p as ShieldCheck, Q as QrCode, ae as Lock, a4 as ArrowLeft, F as Flame, ax as GripVertical, g as Crown, a as Circle, d as ChevronRight } from "../_libs/lucide-react.mjs";
...
function BuilderIntro({ completedThrough, onGoToStep, onTemplate, onDirect }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen bg-background text-foreground flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col items-center justify-center px-5 py-12 sm:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl grid gap-4 sm:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-12 w-12 items-center justify-center rounded-xl bg-primary text-primary-foreground shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelsTopLeft, { className: "h-6 w-6" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex flex-col gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-semibold", children: "Commencer avec un template" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "Choisissez votre métier — votre carte sera pré-remplie avec un modèle adapté." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mt-auto inline-flex items-center gap-1 text-xs font-medium text-primary", children: [
              "Recommandé",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-12 w-12 items-center justify-center rounded-xl bg-muted text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Palette, { className: "h-6 w-6" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex flex-col gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-semibold", children: "Personnaliser depuis le début" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "Partez d'une ardoise vierge et choisissez vos couleurs librement." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-auto text-xs text-muted-foreground", children: "Carte vierge · Thème au choix" })
          ]
        }
      )
    ] }) })
...
function BuilderTheme({ data, update, completedThrough, onGoToStep, onBack, onNext }) {
  const [selectedThemeId, setSelectedThemeId] = reactExports.useState(data.accent ?? "gold");
  const activeTheme = THEMES_BY_ID[selectedThemeId] ?? THEMES_BY_ID.gold;
  const previewData = reactExports.useMemo(
    () => ({ ...data, accent: selectedThemeId }),
    [data, selectedThemeId]
  );
  const handleNext = () => {
    update("accent", selectedThemeId);
    onNext();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen bg-background text-foreground flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-7xl px-5 pb-8 grid grid-cols-1 lg:grid-cols-[1fr_440px] gap-10 flex-1 min-h-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "flex flex-col min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0 overflow-y-auto pr-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: CARD_THEMES.map((t) => {
...
function BuilderSections({ step, data, setData, update, plan, setPlan, completedThrough, onGoToStep, onBack, onNext }) {
  ...
  const handleDragEnd = ({ active, over }) => {
    ...
    update("sectionOrder", arrayMove(so, oldPos, newPos));
  };
  ...
  const ESSENTIAL_BRICKS = ["identity", "actions", "socials", "vcard", "about"];
  const previewData = isEssentials ? { ...data, sectionOrder: data.sectionOrder.filter((b) => ESSENTIAL_BRICKS.includes(b)) } : data;
  ...
  const stepNum = isEssentials ? 4 : 5;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-5 pb-8 grid grid-cols-1 lg:grid-cols-[1fr_440px] gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex flex-col min-h-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(DndContext, { collisionDetection: closestCenter, onDragEnd: handleDragEnd, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SortableContext, { items: defs.map((d) => d.key), strategy: verticalListSortingStrategy, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 mt-4", children: defs.map((d) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            SortableRow,
            {
              ...
              children: open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-5 pt-1 border-t border-border/60", children: renderBrickBody(d.brick, { data, update }) })
            },
            d.key
          );
        }) }) }) }),
            ...
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-0.5", children: [
                  ...
                  def.recommended && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-wider text-primary bg-primary/10 px-1.5 py-0.5 rounded", children: "Recommandé" }),
...
function BuilderPage() {
  ...
  if (step === "intro") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(BuilderIntro, { completedThrough, onGoToStep: goToStep, onTemplate: () => advanceTo("welcome"), onDirect: () => {
      setCompletedThrough((c) => Math.max(c, 3));
      setStep("theme");
    } });
  }
  if (step === "welcome") {
  ...
  if (step === "theme") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(BuilderTheme, { data, update, completedThrough, onGoToStep: goToStep, onBack: () => setStep(data.profession ? "welcome" : "intro"), onNext: () => advanceTo("essentials") });
  }
  if (step === "essentials") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(BuilderSections, { step: "essentials", data, setData, update, plan, setPlan, completedThrough, onGoToStep: goToStep, onBack: () => setStep("theme"), onNext: () => advanceTo("extras") });
  }
  if (step === "extras") {
...
function SuccessStep({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen bg-background text-foreground relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(StepHeader, { step: 6, title: "Félicitations, votre carte est prête !", subtitle: "Activez-la maintenant pour obtenir votre lien public, votre QR code et l'accès à votre dashboard.", completedThrough, onGoToStep: goToStep, nextHint: "Dernière étape : activer votre carte." }),
