...
import { P as PublicLinkBar, Q as QrCard, S as ShareGrid, T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./ShareGrid-CzMrELqb.mjs";
import { B as BrickList } from "./BrickList-DB2kHEBK.mjs";
import { B as BusinessCard } from "./BusinessCard-V1OWDR6k.mjs";
import { P as PhoneFrame } from "./bricks-CnHPsE_Z.mjs";
import { u as useCardStore, h as getProfileMeta, C as CARD_THEMES } from "./router-CiWqVICH.mjs";
import { l as loadMyCard, u as updateCard } from "./card-actions-BccnFU6Q.mjs";
import "../_libs/qrcode.mjs";
import "../_libs/sonner.mjs";
import "../_libs/dnd-kit__core.mjs";
import "../_libs/dnd-kit__sortable.mjs";
import "../_libs/seroval.mjs";
import { N as Sparkles, H as Smartphone, ad as Share2, aV as Layers, ae as Palette, w as Check, A as ArrowRight } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1500px] px-5 sm:px-8 py-8 grid grid-cols-1 xl:grid-cols-[420px_1fr] gap-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "content", className: "w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "content", className: "mt-0 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { title: "Briques de la carte", subtitle: "Activez, modifiez ou réordonnez chaque section. L'aperçu se met à jour en direct." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "theme", className: "mt-0 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { title: "Thème global", subtitle: "Une palette s'applique à toute la carte. Choisissez l'ambiance qui correspond à votre métier." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3", children: CARD_THEMES.map((t) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => update("accent", t.id), className: `group relative text-left rounded-2xl border p-3 transition hover:-translate-y-0.5 ${active ? "border-primary ring-2 ring-primary/40 shadow-[var(--shadow-glow)]" : "border-border hover:border-foreground/30"}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "style", className: "mt-0 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { title: "Style par brique", subtitle: "Chaque brique propose plusieurs variantes visuelles. Déroulez une brique pour choisir son style." }),
