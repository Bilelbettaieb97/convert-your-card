...
import { C as Countdown } from "./router-DQU19SRg.mjs";
import "../_libs/seroval.mjs";
import { Z as Zap, L as LayoutDashboard, a as LogOut, w as CreditCard, a2 as Shield, a3 as Truck, S as Sparkles, m as Check, X, A as ArrowRight, J as ChevronDown, q as Star, n as Clock, B as Building2, a4 as House, U as UtensilsCrossed, G as GraduationCap, c as Scissors, b as HardHat, a5 as Smartphone, a6 as BadgeCheck, p as Users, a7 as ChartColumn, a8 as Award, a9 as ThumbsUp, aa as Play, ab as ChevronLeft, _ as ChevronRight, ac as RefreshCw, V as Lock, ad as Headphones, ae as Leaf, T as TrendingUp, af as Quote, M as MessageCircle, ag as ShoppingBag, a0 as MapPin, l as Gift, ah as LoaderCircle, F as Wifi, $ as Phone, a1 as Mail, s as Globe, ai as Linkedin, aj as Instagram } from "../_libs/lucide-react.mjs";
...
const url$5 = "/__l5e/assets-v1/9f03a095-d4c7-4737-a161-6bacddbd50aa/t1-agency.png";
const t1Asset = {
  url: url$5
};
const url$4 = "/__l5e/assets-v1/c301a82f-8695-40c5-9502-c30dc6072ca7/t2-realestate.png";
const t2Asset = {
  url: url$4
};
const url$3 = "/__l5e/assets-v1/79ea9419-2e4d-4607-bc4f-78e1a3c0c9bc/t3-restaurant.png";
const t3Asset = {
  url: url$3
};
const url$2 = "/__l5e/assets-v1/1dc01ef2-1c00-4d44-a97c-3adc7587daac/t4-coach.png";
const t4Asset = {
  url: url$2
};
const url$1 = "/__l5e/assets-v1/f7818959-1186-4d8e-b660-b6557ecc2945/t5-beauty.png";
const t5Asset = {
  url: url$1
};
const url = "/__l5e/assets-v1/8b967c26-6649-4f15-beb6-69471ccc7512/t6-artisan.png";
const t6Asset = {
  url
};
function Landing() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "fonctionnement", className: "py-8 sm:py-10 lg:py-12 bg-gradient-soft overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 lg:mt-10 grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-14 lg:items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full order-1 lg:order-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative hidden lg:block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-[2.5rem] border border-border bg-card/60 backdrop-blur-sm shadow-card p-8 xl:p-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 rounded-full bg-background border border-border px-3 py-1.5 text-xs font-semibold", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `h-2 w-2 rounded-full bg-gradient-to-r ${activeTemplate.accent}` }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-[280px] xl:w-[320px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: activeTemplate.image, alt: `Exemple de carte digitale — ${activeTemplate.sector}`, className: "block w-full h-auto drop-shadow-[0_30px_60px_rgba(0,0,0,0.25)] animate-in fade-in zoom-in-95 duration-500" }, activeTemplate.id),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex justify-center lg:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-[200px] sm:w-[280px] md:w-[320px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: activeTemplate.image, alt: `Exemple de carte digitale — ${activeTemplate.sector}`, className: "block w-full h-auto drop-shadow-[0_30px_60px_rgba(0,0,0,0.25)] animate-in fade-in zoom-in-95 duration-500" }, `m-${activeTemplate.id}`),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-2 lg:order-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:grid grid-cols-1 gap-2.5", children: templates.map((template, index) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setActiveIndex(index), "aria-pressed": isActive, className: `group relative w-full text-left rounded-2xl border px-4 py-4 transition-all duration-300 overflow-hidden ${isActive ? "bg-card border-magenta/40 shadow-card translate-x-1" : "bg-background/60 border-border hover:bg-card hover:border-magenta/20 hover:translate-x-0.5"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b ${template.accent} transition-opacity ${isActive ? "opacity-100" : "opacity-0 group-hover:opacity-50"}`, "aria-hidden": true }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `shrink-0 h-11 w-11 rounded-xl flex items-center justify-center bg-gradient-to-br ${template.accent} text-white shadow-sm transition-transform ${isActive ? "scale-105" : "opacity-80 group-hover:opacity-100"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-5 h-5" }) }),
